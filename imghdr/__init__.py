"""Fallback imghdr package for hosted runtimes.

This duplicates the small shim in the repository root (`imghdr.py`) but
packages it so import resolution will succeed whether the runtime prefers
packages or modules.
"""
